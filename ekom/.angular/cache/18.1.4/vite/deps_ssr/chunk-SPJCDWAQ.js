...
var SelectionModel = class {
  ...
  constructor(_multiple = false, initiallySelectedValues, _emitChanges = true, compareWith) {
    ...
    this.changed = new import_rxjs5.Subject();
...
var _CdkScrollable = class _CdkScrollable {
  constructor(elementRef, scrollDispatcher, ngZone, dir) {
    ...
    this._elementScrolled = new import_rxjs6.Observable((observer) => this.ngZone.runOutsideAngular(() => (0, import_rxjs6.fromEvent)(this.elementRef.nativeElement, "scroll").pipe((0, import_operators5.takeUntil)(this._destroyed)).subscribe(observer)));
  }
  ngOnInit() {
...
var _CdkVirtualScrollableWindow = class _CdkVirtualScrollableWindow extends CdkVirtualScrollable {
  constructor(scrollDispatcher, ngZone, dir) {
    ...
    this._elementScrolled = new import_rxjs6.Observable((observer) => this.ngZone.runOutsideAngular(() => (0, import_rxjs6.fromEvent)(document, "scroll").pipe((0, import_operators5.takeUntil)(this._destroyed)).subscribe(observer)));
  }
  measureBoundingClientRectWithScrollOffset(from) {
    return this.getElementRef().nativeElement.getBoundingClientRect()[from];
  }
...
var OverlayRef = class {
  ...
  _detachContentWhenEmpty() {
    this._ngZone.runOutsideAngular(() => {
      const subscription = this._renders.pipe((0, import_operators6.takeUntil)((0, import_rxjs7.merge)(this._attachments, this._detachments))).subscribe(() => {
...
//# sourceMappingURL=chunk-SPJCDWAQ.js.map
